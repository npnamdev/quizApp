  ...
  <div>
    ...
    >
        ...
        <div class="form-add-post">
          ...
          <div class="box-images">
            <input
              type="file"
              @change="previewImage"
              id="input-preview-post-update"
              hidden
            />
            <div class="box-image-top">
              <label for="input-preview-post-update">
                <box-icon
                  size="18px"
                  color="#95a5a6"
                  name="folder-plus"
      ...
      <template #footer>
        ...
        <button class="btn-action" @click="handleUpdatePost">Save</button>
      </template>
...
export default {
  data() {
    return {
      ...
      modalUpdate: this.modalUpdatePost,
      title: "",
      description: "",
      contents: "",
      category: "",
  ...
  props: ["modalUpdatePost", "setModalUpdatePost", "dataUpdate"],
  methods: {
    previewImage(event) {
  ...
  watch: {
    ...
    dataUpdate(newValue) {
      ...
      this.contents = newValue.content;
      this.category = newValue.category.name;
      this.categoryId = newValue.category._id;
