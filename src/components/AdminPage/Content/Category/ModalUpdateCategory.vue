<template>
  <div>
    <b-modal v-model="modalUpdate" no-close-on-backdrop>
      <template #header>
...
export default {
  data() {
    return {
      modalUpdate: this.modalUpdateCategory,
      name: "",
      description: "",
    };
  },
  props: ["modalUpdateCategory", "setModalUpdateCategory", "dataUpdate"],
  methods: {
    handleClone() {
      this.setModalUpdateCategory(false);
    },
